...
* Factors represent are used categorical variables in R. They are a unique data type that under the hood maps character strings to integers.  
...
Now we pivot wider on the replicate "CM" (colony morphology) columns.  Note that the information in the headers become entries in the "Replicate" column:
